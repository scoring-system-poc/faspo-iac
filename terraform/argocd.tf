      ...
      configs = {
        ...
        repositories = {
          git = {
            ...
            sshPrivateKey = sensitive(base64decode(var.ARGOCD_DEPLOY_KEY))
          }
          helm = {
            type      = "helm"
            ...
            password  = sensitive(azurerm_container_registry_token_password.argocd-acr-token-pwd.password1.0.value)
            enableOCI = "true"
          }
        }
      }
